...
class TitledItemTests: XCTestCase {
    ...
    func testComparison_betweenDifferentCategories_sameName() {
        let magazine = TitledItem(name: title, category: Category.magazine,
                                  isInventoryItem: true, isOrderItem: true, imageString: imageString)
        let book = TitledItem(name: title, category: Category.book,
                              isInventoryItem: true, isOrderItem: true, imageString: imageString)
    ...
    func testComparison_betweenDifferentCategories_differentName() {
        ...
        let magazine = TitledItem(name: String(title.dropFirst()), category: Category.magazine,
                                  isInventoryItem: true, isOrderItem: true, imageString: imageString)
        let book = TitledItem(name: title, category: Category.book,
                              isInventoryItem: true, isOrderItem: true, imageString: imageString)
        XCTAssertTrue(book < magazine)
    ...
    func testEquals() {
        let titledItem = TitledItem(name: title, category: Category.book, isInventoryItem: true,
                                    isOrderItem: true, imageString: imageString)
        XCTAssertTrue(titledItem.equals(other: titledItem))

        let copyOfTitledItem = TitledItem(name: title, category: Category.book, isInventoryItem: true,
                                          isOrderItem: true, imageString: imageString)
        XCTAssertTrue(titledItem.equals(other: copyOfTitledItem))

        let itemWithDifferentTitle = TitledItem(name: title + "a", category: Category.book, isInventoryItem: true,
                                                isOrderItem: true, imageString: imageString)
